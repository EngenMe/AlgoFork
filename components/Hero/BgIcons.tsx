  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/js.svg"
        alt="JavaScript"
      ...
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/java.svg"
        alt="Java"
      ...
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/python.svg"
        alt="Python"
      ...
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/c.svg"
        alt="C"
      ...
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/r.svg"
        alt="R"
      ...
      <Image
        width={50}
        height={50}
        src="/heroProgrammingLanguages/swift.svg"
        alt="Swift"
